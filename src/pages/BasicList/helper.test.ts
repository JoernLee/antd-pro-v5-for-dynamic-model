...
import { setFieldsValueAdapter } from './helper';
...
describe('setFieldsValueAdapter', () => {
  test('Invalid parameter should return empty object', () => {
    expect(setFieldsValueAdapter(null as any)).toEqual({});
    expect(setFieldsValueAdapter(undefined as any)).toEqual({});
    expect(setFieldsValueAdapter({} as any)).toEqual({});
    expect(setFieldsValueAdapter([] as any)).toEqual({});
  });

  test('valid parameter should return true object', () => {
    expect(setFieldsValueAdapter(setFieldsAdaptorParams as any)).toEqual(setFieldsAdaptorResult);
  });
});
